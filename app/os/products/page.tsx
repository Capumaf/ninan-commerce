    ...
    <div className="p-10">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          ...
          style={{ background: "linear-gradient(135deg, #1a3356, #2563a8)", border: "1px solid rgba(255,255,255,0.1)" }}
        >
          + New Product
        </Link>
      </div>
        ...
        <div className="flex flex-col gap-px bg-white/5 rounded-xl overflow-hidden border border-white/5">
          {products.map((p) => (
            <Link
              ...
              className="flex items-center justify-between bg-[#0a1220] px-6 py-4 hover:bg-[#0e1c30] transition-colors"
            >
              <div>
              ...
              <span
                ...
                style={{
                  background: p.status === "ACTIVE" ? "rgba(34,197,94,0.1)" : "rgba(37,99,168,0.1)",
                  border: p.status === "ACTIVE" ? "1px solid rgba(34,197,94,0.2)" : "1px solid rgba(37,99,168,0.2)",
